...
## Project Structure
+ `data/`: a folder containing the input datas (input relations, FD sets, RCs). There are two examples for a demo below stored in `data/example/` and `data/example2/` respectively
...
```
There will be 3 parts of inputs. The first part is the output in terminal:
```
